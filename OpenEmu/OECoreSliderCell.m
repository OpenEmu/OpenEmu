...
+ (void)initialize{
	NSImage* image = [NSImage imageNamed:@"core_slider_track"];

	[image setName:@"core_slider_track_normal" forSubimageInRect:NSMakeRect(0, 0, 8, 6)];
	[image setName:@"core_slider_track_inactive" forSubimageInRect:NSMakeRect(0, 6, 8, 6)];
	
	image = [NSImage imageNamed:@"core_slider_thumb"];
	[image setName:@"core_slider_thumb_normal" forSubimageInRect:NSMakeRect(18, 0, 18, 21)];
	[image setName:@"core_slider_thumb_inactive" forSubimageInRect:NSMakeRect(0, 0, 18, 21)];
}
#pragma mark -
...
- (void)drawKnob:(NSRect)knobRect{
	NSImage* knobImage = [NSImage imageNamed:@"core_slider_thumb_normal"];
...
- (void)drawBarInside:(NSRect)aRect flipped:(BOOL)flipped{
	...
	NSImage* img = [NSImage imageNamed:@"core_slider_track_normal"];
